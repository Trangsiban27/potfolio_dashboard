...
export const getUser = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      "http://localhost:4000/api/v1/user/getMe",
    ...
    dispatch(userSlice.actions.loadUserFailed(e.response.data.message));
  }
};
...
export const updatePassword =
  (currentPassword, newPassword, confirmNewPassword) => async (dispatch) => {
    ...
    try {
      ...
      dispatch(userSlice.actions.updatePasswordFailed(e.response.data.message));
    }
  };
...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    ...
    dispatch(userSlice.actions.updateProfileFailed(e.response.data.message));
  }
};
